(() => {
  ...
  Object.assign(globalThis, { withCurrentLocalCollection, refreshAccountQuickPreferences, passportDate, passportRelativeUpdate, passportReliabilityLabel, passportSinceMonth, passportAvatarHtml, formatCollectionProgressText, formatBadgeAccessibleName, logPassportAnalytics, announcePassportStatus, passportSeniority, passportActivityLabel, passportActivityDayLabel, groupPassportActivityByDay, passportVerificationLabel, passportBadgeCategoryLabel, openPassportCollectionFilter, openPassportEventMissing, passportEventEndLabel });
  });
})();
