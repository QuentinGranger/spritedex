(() => {
  ...
  Object.assign(window, { loadCatalog, renderCatalogEmptyState, selectCatalog, renderBulkBar, toggleBulkPage, bulkPreviewItems, openBulkAction, closeBulkAction, submitBulkAction, renderCatalogEditor, spriteEditableField });
})();
