(() => {
  ...
  Object.assign(window, { queryLanguage, francophoneRegions, locales, french, english, locale, number, dateTime, dateOnly, $, $$, state, copy, headings, tr, escapeHtml, adminImageUrl, adminCatalogImage, formatNumber, formatDate, formatPercent, formatDuration, toLocalInput, label, reportPriorityTone, reportPriorityLabel, reportContextMarkup, sessionRemainingMs, can, needsStepUp, readStepUpCode, stepUpHeaders, assertStepUp, firstAllowedTab, applyAuthz, renderSessionBadge, bootstrapSession, setAlert, setNotice, setLoading, closeReasonDialog, requestReason, adminFetch, request, kpi, status, empty });
})();
