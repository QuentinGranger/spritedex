...
app.get(
  "/api/admin/overview",
  requireAdminCapability("overview.read"),
  route(async (_req, res) => {
    ...
    res.json({
      ...
      database: {
        ...
        status: "ok",
        latencyMs: Math.round(databaseLatencyMs),
        checkedAt: databaseProbe.rows[0]?.checked_at,
        startedAt: databaseProbe.rows[0]?.started_at
      },
      health: {
