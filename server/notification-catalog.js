...
// Compatibility facade. Notification metadata, wording and rendering are split by concern.
const api = Object.assign(
  {},
  require("./notification-catalog/constants"),
  require("./notification-catalog/priority"),
  require("./notification-catalog/settings"),
  require("./notification-catalog/locale"),
  require("./notification-catalog/definitions"),
  require("./notification-catalog/renderer"),
  require("./notification-catalog/accessors")
);
