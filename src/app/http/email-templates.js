...
const EMAIL_COPY = Object.freeze({
  fr: Object.freeze({
    ...
    brandKicker: "Fan-made · Collection Fortnite",
    verifySubject: "Confirme ton email — SPRITE-INDEX",
    verifyEyebrow: "Mission active",
    verifyHeading: "Confirme ton email pour drop",
    ...
    resetEyebrow: "Sécurise ton loadout",
    resetHeading: "Réinitialise ton mot de passe",
    resetIntro: "Une demande de reset a été faite sur ton compte. Ce lien expire dans 1 heure — après, il faudra en demander un nouveau.",
    ...
    notifEyebrow: "Ping",
    linkFallback: "Le bouton ne marche pas ? Copie ce lien :",
    footerNote: "Ne partage jamais ce lien. Email envoyé par SPRITE-INDEX.",
    fanDisclaimer: "SPRITE-INDEX est une app fan-made de suivi de collection. Non affiliée, sponsorisée ou approuvée par Epic Games. Fortnite est une marque d’Epic Games."
  }),
  en: Object.freeze({
    ...
    resetEyebrow: "Secure your loadout",
  ...
  nl: Object.freeze({
    ...
    resetEyebrow: "Beveilig je loadout",
    resetHeading: "Stel je wachtwoord opnieuw in",
    resetIntro: "Er is een verzoek gedaan om je wachtwoord te resetten. Deze link verloopt over 1 uur — daarna vraag je een nieuwe aan.",
