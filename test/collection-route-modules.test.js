...
const modules = fs.readdirSync(collectionDirectory).filter(file => file.endsWith(".js")).sort();

assert.deepStrictEqual(modules, ["effects.js", "entry.js", "import.js", "maintenance.js", "read.js", "shared.js", "sync.js"]);
...
assert.match(effects, /notifyCollectionChanges|emitVariantAcquiredEvents|scheduleSquadStatsForUser/, "shared write effects must stay centralized");
